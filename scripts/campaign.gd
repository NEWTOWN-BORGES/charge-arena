...
const LEVELS = [
	{"name": "Circuito Aurora", "tag": "Treino", "boss": 0, "tier": 0,
		...
		"map": {"id": "treino", "outline": "stadium", "boosters": true, "bricks": "banks", "lives": 3, "barriers": [], "obstacles": []}},
	...
	{"name": "Mina Profunda", "tag": "Vagonetas", "boss": 4, "tier": 2,
		...
		"map": {"id": "mina", "outline": "colosseum", "boosters": true, "bricks": "chevron", "lives": 3, "barriers": [],
			"obstacles": [
	...
	{"name": "Laboratório de Cristal", "tag": "Quatro cristais", "boss": 8, "tier": 3,
		...
		"map": {"id": "laboratorio", "outline": "gorge", "boosters": true, "bricks": "islands", "lives": 3, "barriers": [],
			"obstacles": [
	...
	{"name": "Oficina do Relógio", "tag": "Deslizadores", "boss": 6, "tier": 4,
		...
		"map": {"id": "oficina", "outline": "stadium", "boosters": true, "bricks": "arc", "lives": 3, "barriers": [],
			"obstacles": [
	...
	{"name": "Estufa Suspensa", "tag": "Cintura estreita", "boss": 3, "tier": 5,
		...
		"map": {"id": "estufa", "outline": "gorge", "boosters": true, "bricks": "bulwark", "lives": 3, "barriers": [],
			"obstacles": [
	...
	{"name": "Recife dos Corsários", "tag": "Coliseu", "boss": 9, "tier": 6,
		...
		"map": {"id": "recife", "outline": "colosseum", "boosters": true, "bricks": "banks", "lives": 4, "barriers": [],
			"obstacles": [
	...
	{"name": "Observatório Lunar", "tag": "Duas luas", "boss": 2, "tier": 8,
		...
		"map": {"id": "observatorio", "outline": "lens", "boosters": false, "bricks": "fortress", "lives": 3, "barriers": [],
			"obstacles": [
	...
	{"name": "Santuário Eclipse", "tag": "Quatro luas", "boss": 5, "tier": 9,
		...
		"map": {"id": "santuario", "outline": "octagon", "boosters": true, "bricks": "fortress", "lives": 4, "barriers": [],
			"obstacles": [

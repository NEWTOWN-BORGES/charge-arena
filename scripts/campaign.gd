...
const LEVELS = [
	...
	{"name": "Oficina do Relógio", "tag": "Deslizadores", "boss": 6, "tier": 1,
		...
		"map": {"id": "oficina", "outline": "stadium", "boosters": true, "bricks": "chevron", "barriers": [],
			"obstacles": [
				{"kind": "slide", "center": Vector2(-6.2, 0), "axis": Vector2(0, 1), "travel": 2.2, "frequency": 0.6, "phase": 0.0, "radius": 0.44},
				{"kind": "slide", "center": Vector2(6.2, 0), "axis": Vector2(0, 1), "travel": 2.2, "frequency": 0.6, "phase": PI, "radius": 0.44}]}},
	{"name": "Baía do Farol", "tag": "Faróis giratórios", "boss": 1, "tier": 2,
		...
		"map": {"id": "farol", "outline": "octagon", "boosters": true, "bricks": "wall", "barriers": [],
			"obstacles": [
				{"kind": "orbit", "center": Vector2(-5.9, 0), "travel": 0.9, "frequency": 0.5, "phase": 0.0, "radius": 0.46},
				{"kind": "orbit", "center": Vector2(5.9, 0), "travel": 0.9, "frequency": 0.5, "phase": PI, "radius": 0.46},
	...
	{"name": "Estufa Suspensa", "tag": "Cintura estreita", "boss": 3, "tier": 3,
		...
		"map": {"id": "estufa", "outline": "gorge", "boosters": true, "bricks": "arc", "barriers": [],
			"obstacles": [
				{"kind": "slide", "center": Vector2(-5.0, 0), "axis": Vector2(0, 1), "travel": 1.6, "frequency": 0.55, "phase": 0.0, "radius": 0.42},
				{"kind": "slide", "center": Vector2(5.0, 0), "axis": Vector2(0, 1), "travel": 1.6, "frequency": 0.55, "phase": PI, "radius": 0.42}]}},
	{"name": "Observatório Lunar", "tag": "Duas luas", "boss": 2, "tier": 4,
		...
		"map": {"id": "observatorio", "outline": "lens", "boosters": false, "bricks": "islands", "barriers": [],
			"obstacles": [
				{"kind": "orbit", "center": Vector2(-6.4, 0), "travel": 1.3, "frequency": 0.36, "phase": 0.0, "radius": 0.43},
				{"kind": "orbit", "center": Vector2(6.4, 0), "travel": 1.3, "frequency": 0.36, "phase": PI, "radius": 0.43}]}},
	{"name": "Mina Profunda", "tag": "Vagonetas", "boss": 4, "tier": 5,
		...
		"map": {"id": "mina", "outline": "colosseum", "boosters": true, "bricks": "chevron", "barriers": [],
			"obstacles": [
				{"kind": "slide", "center": Vector2(-6.5, 0), "axis": Vector2(0, 1), "travel": 2.4, "frequency": 0.65, "phase": 0.0, "radius": 0.44},
				{"kind": "slide", "center": Vector2(6.5, 0), "axis": Vector2(0, 1), "travel": 2.4, "frequency": 0.65, "phase": PI, "radius": 0.44}]}},
	{"name": "Santuário Eclipse", "tag": "Quatro luas", "boss": 5, "tier": 6,
		...
		"map": {"id": "santuario", "outline": "octagon", "boosters": true, "bricks": "banks", "barriers": [],
			"obstacles": [
				{"kind": "orbit", "center": Vector2(-6.6, -1.6), "travel": 0.8, "frequency": 0.42, "phase": 0.0, "radius": 0.42},
				{"kind": "orbit", "center": Vector2(6.6, -1.6), "travel": 0.8, "frequency": 0.42, "phase": PI, "radius": 0.42},
				{"kind": "orbit", "center": Vector2(-6.6, 1.6), "travel": 0.8, "frequency": 0.42, "phase": PI, "radius": 0.42},
				{"kind": "orbit", "center": Vector2(6.6, 1.6), "travel": 0.8, "frequency": 0.42, "phase": 0.0, "radius": 0.42}]}},
	{"name": "Torre da Tempestade", "tag": "Pára-raios", "boss": 7, "tier": 7,
		...
		"map": {"id": "tempestade", "outline": "lens", "boosters": true, "bricks": "chevron", "barriers": [],
			"obstacles": [
				{"kind": "slide", "center": Vector2(-6.6, 0), "axis": Vector2(0, 1), "travel": 2.0, "frequency": 0.72, "phase": 0.0, "radius": 0.43},
				{"kind": "slide", "center": Vector2(6.6, 0), "axis": Vector2(0, 1), "travel": 2.0, "frequency": 0.72, "phase": PI, "radius": 0.43}]}},
	{"name": "Laboratório de Cristal", "tag": "Quatro cristais", "boss": 8, "tier": 8,
		...
		"map": {"id": "laboratorio", "outline": "gorge", "boosters": true, "bricks": "islands", "barriers": [],
			"obstacles": [
				{"kind": "orbit", "center": Vector2(-4.9, -1.5), "travel": 0.7, "frequency": 0.5, "phase": 0.0, "radius": 0.4},
				{"kind": "orbit", "center": Vector2(4.9, -1.5), "travel": 0.7, "frequency": 0.5, "phase": PI, "radius": 0.4},
				{"kind": "orbit", "center": Vector2(-4.9, 1.5), "travel": 0.7, "frequency": 0.5, "phase": PI, "radius": 0.4},
				{"kind": "orbit", "center": Vector2(4.9, 1.5), "travel": 0.7, "frequency": 0.5, "phase": 0.0, "radius": 0.4}]}},
	{"name": "Recife dos Corsários", "tag": "Coliseu", "boss": 9, "tier": 9,
		...
		"map": {"id": "recife", "outline": "colosseum", "boosters": true, "bricks": "wall", "barriers": [],
			"obstacles": [
				{"kind": "orbit", "center": Vector2(-6.3, 0), "travel": 1.0, "frequency": 0.48, "phase": 0.0, "radius": 0.42},
				{"kind": "orbit", "center": Vector2(6.3, 0), "travel": 1.0, "frequency": 0.48, "phase": PI, "radius": 0.42}]}},
	{"name": "Coroa Solar", "tag": "Tudo junto", "boss": 10, "tier": 10,
		...
		"map": {"id": "coroa", "outline": "stadium", "boosters": true, "bricks": "arc",
			"barriers": [
				{"a": Vector2(-7.2, -1.2), "b": Vector2(-6.5, 0)}, {"a": Vector2(-6.5, 0), "b": Vector2(-7.2, 1.2)},
				{"a": Vector2(7.2, -1.2), "b": Vector2(6.5, 0)}, {"a": Vector2(6.5, 0), "b": Vector2(7.2, 1.2)}],
			"obstacles": [
				{"kind": "slide", "center": Vector2(-5.4, 0), "axis": Vector2(0, 1), "travel": 2.4, "frequency": 0.5, "phase": 0.0, "radius": 0.42},
				{"kind": "slide", "center": Vector2(5.4, 0), "axis": Vector2(0, 1), "travel": 2.4, "frequency": 0.5, "phase": PI, "radius": 0.42},
				{"kind": "orbit", "center": Vector2(-6.4, -4.4), "travel": 0.8, "frequency": 0.43, "phase": 0.0, "radius": 0.41},
				{"kind": "orbit", "center": Vector2(6.4, -4.4), "travel": 0.8, "frequency": 0.43, "phase": PI, "radius": 0.41},
				{"kind": "orbit", "center": Vector2(-6.4, 4.4), "travel": 0.8, "frequency": 0.43, "phase": PI, "radius": 0.41},
				{"kind": "orbit", "center": Vector2(6.4, 4.4), "travel": 0.8, "frequency": 0.43, "phase": 0.0, "radius": 0.41}]}},
]

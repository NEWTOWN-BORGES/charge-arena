...
const CATALOG = [
	{"name": "PILOTO AURORA", "ultimate": "", "weapon": "Manopla de energia", "bricks": "Baterias Aurora", "about": "O equipamento de série do circuito.", "level": 0,
		"body": "", "light": "", "shot": ""},
	{"name": "FAROLEIRO", "ultimate": "", "weapon": "Lança-Farol", "bricks": "Farolins", "about": "Guarda dos faróis flutuantes: cúpula de latão, lanterna às costas e lança de cristal.", "level": 2,
	...
	{"name": "MINEIRO", "ultimate": "", "weapon": "Perfuradora de Cristal", "bricks": "Veios de cristal", "about": "Extrai cristais dos asteroides: capacete de obra com lanterna, carga de minério às costas e broca de quartzo.", "level": 3,
	...
	{"name": "RELOJOEIRO", "ultimate": "sentries", "weapon": "Canhão de Corda", "bricks": "Relógios de torre", "about": "Afina as engrenagens do circuito: monóculo de lupa, chave de corda nas costas e canhão de molas.", "level": 5,
	...
	{"name": "ALQUIMISTA", "ultimate": "", "weapon": "Frasco de Plasma", "bricks": "Alambiques", "about": "Destila plasma das nebulosas: óculos de latão, alambique às costas e frascos borbulhantes.", "level": 4,
